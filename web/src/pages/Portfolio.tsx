...
function PortfolioEquityChart({ curve, trades }: {
  ...
  const option = useMemo(() => ({
    ...
    series: [
      { name: '权益', type: 'line' as const, data: equityData, smooth: true,
      ...
      { name: '回撤', type: 'line' as const, yAxisIndex: 1, data: drawdownData,
        lineStyle: { color: '#EF4444', width: 1, type: 'dashed' as const },
        itemStyle: { color: '#EF4444' } },
      { name: '盈利', type: 'scatter' as const, data: buyPoints, symbolSize: 8,
        itemStyle: { color: '#22C55E' } },
      { name: '亏损', type: 'scatter' as const, data: sellPoints, symbolSize: 8,
        itemStyle: { color: '#EF4444' } },
    ],
